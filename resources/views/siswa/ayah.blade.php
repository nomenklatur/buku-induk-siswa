      ...
      <div class="row">
          <div class="col-lg-4">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="tempat_lahir" value="{{$res->tempat_lahir}}">
            </div>
            <div class="mb-3">
          ...
          <div class="col-lg-4">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="kewarganegaraan" value="{{$res->kewarganegaraan}}">
            </div>
            <div class="mb-3">
              <label for="pekerjaan" class="form-label">Pekerjaan</label>
              <input type="text" class="form-control" name="pekerjaan" value="{{$res->pekerjaan}}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" name="penghasilan" value="{{$res->penghasilan}}">
            </div>
          </div>
          <div class="col-lg-4">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="nomor_hp" value="{{$res->nomor_hp}}">
            </div>
            <div class="mb-3">
              <p>Status Orang Tua</p>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="status" value="Masih Hidup" @if ($res->status == 'Masih Hidup') checked @endif>
                <label class="form-check-label" for="inlineRadio1">Masih hidup</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="status" value="Telah Meninggal" @if ($res->status == 'Telah Meninggal') checked @endif>
