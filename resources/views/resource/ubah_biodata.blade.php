...
@section('content')
    <div class="container mt-3 card shadow">
      <div class="row justify-content-center mb-3">
        <div class="col-lg-9">
          <form action="/biodata/{{$uri}}" method="post" name="form_edit">
            @method('PUT')
            @csrf
            <div class="container">
              <!-- Tabs navs -->
                  ...
                  <div class="tab-content" id="ex2-content" style="height: fit-content">
                    ...
                    <h3 class="text-uppercase text-center">{{$title}}</h3>
                      <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Contoh : Jl. Kemuning No.7" name="alamat" value="{{$data->alamat}}">
                      </div>
                      <div class="input-group mb-3">
